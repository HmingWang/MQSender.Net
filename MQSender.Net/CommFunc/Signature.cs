...
namespace MQSender.Net
{
    class Signature
    {
        ...
        public string HashAndSign(byte[] plainText)
        {
            ...
            byte[] encryptedData = RSAalg.SignData(dataToEncrypt, new MD5CryptoServiceProvider());//MD5
            //得到签名
        ...
        public bool VerifySigned(byte[] plaintext, string signedData)
        {
            //根据证书友好名称查找证书
            ...
            byte[] dataToVerifyBytes = plaintext;
            //将签名转byte[]
